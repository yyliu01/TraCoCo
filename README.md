...
Note: parts of the tables are borrowed from [here](https://github.com/HiLab-git/DTC/blob/master/README.md), and our train/val sample index follows [UA-MT](https://github.com/yulequan/UA-MT/tree/master/data). Our fully training details (i.e., checkpoints and training logs) are available in this [one-drive](https://1drv.ms/u/s!AsvBenvUFxO3hn0BLwjDwSG3Q3pE?e=fT0Df9) link.
### Acknowledgement
